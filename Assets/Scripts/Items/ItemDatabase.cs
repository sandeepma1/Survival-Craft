...
//int itemId, string itemName, int itemMaxAge, ItemType itemType, ItemTool itemTool, float itemHardness, bool isItemHandMined, float itemExperience, int itemDrops, int itemDropRateMin, int itemDropRateMax
		...
		items [12] = new Item (12, "Small Tree", 2, 13, Item.ItemType.Tree, Item.ItemTool.Axe, 3, false, 0, 5, 1, 1);
		items [13] = new Item (13, "Medium Tree", 2, 14, Item.ItemType.Tree, Item.ItemTool.Axe, 8, false, 0, 5, 1, 2);
		items [14] = new Item (14, "Large Tree", 2, 15, Item.ItemType.Tree, Item.ItemTool.Axe, 10, false, 0, 5, 2, 3);
		items [15] = new Item (15, "Mature Tree", 2, -1, Item.ItemType.Tree, Item.ItemTool.Axe, 10, false, 0, 5, 2, 3);
		//Berries
		...
		//Radish
		items [21] = new Item (21, "Radish", -1, -1, Item.ItemType.Food, Item.ItemTool.Hand, 0.2f, true, 0, 7, 1, 3);
		//Radish Plant
		items [22] = new Item (22, "Radish Plant", 5, -1, Item.ItemType.RawMaterial, Item.ItemTool.Hand, 0.5f, true, 0, 7, 1, 2);
