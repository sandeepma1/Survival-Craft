...
{
    [AddComponentMenu("InventorySystem/Integration/DialogueSystem/Inventory dialogue loot quest")]
    public class InventoryDialogueLootQuest : MonoBehaviour
    {
        ...
        public InventoryItemAmountRow requiredItem = new InventoryItemAmountRow();
        ...
        private void UpdateCount(uint itemID)
        {
            ...
            DialogueLua.SetVariable(actualVariableName, _currentCount);
