...
//        public int indexInCategory;
        ...
        /// </summary>
        public InventoryItemAmountRow[] requiredItems = new InventoryItemAmountRow[0];

        /// <summary>
        /// Usage requirement properties. For example, the player needs at least 10 strength to craft this item.
        /// </summary>
        public InventoryItemPropertyRequirementLookup[] usageRequirementProperties = new InventoryItemPropertyRequirementLookup[0];
        ...
        /// </summary>
        public InventoryItemAmountRow[] resultItems = new InventoryItemAmountRow[0];
