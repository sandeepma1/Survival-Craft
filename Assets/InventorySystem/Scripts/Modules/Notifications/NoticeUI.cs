...
namespace Devdog.InventorySystem
{
    ...
    [HelpURL("http://devdog.nl/documentation/noticeui-notifications/")]
    ...
    public partial class NoticeUI : MonoBehaviour
    {
        ...
        public InventoryAudioClip onNewMessageAudioClip;
        ...
        public virtual void AddMessage(InventoryNoticeMessage message)
        {
            ...
            if (noticeRowPrefab != null)
            {
                ...
                InventoryAudioManager.AudioPlayOneShot(onNewMessageAudioClip);
                messages.Add(item);
            }
