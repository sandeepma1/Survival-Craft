...
namespace Devdog.InventorySystem.Models
{
    ...
    public partial class InventoryItemFilter
    {
        ...
        public InventoryItemCategory categoryValue
        {
            get
            {
                return ItemManager.database.itemCategories.First(o => o.ID == intValue);
            }
        }
        ...
        public InventoryItemRarity rarityValue
        {
            get
            {
                return ItemManager.database.itemRarities.First(o => o.ID == intValue);
            }
        }
        ...
        public InventoryItemProperty propertyValue
        {
            get
            {
                return ItemManager.database.properties.First(o => o.ID == intValue);
            }
        }
        ...
        public bool IsItemAbidingFilter(InventoryItemBase item)
        {
            switch (restrictionType)
            {
                ...
                case RestrictionType.Category:
                    return VerifyFilterInts((int)item.category.ID, intValue, filterType);
                case RestrictionType.Rarity:
                    return VerifyFilterInts(InventoryUtility.FindIndex(ItemManager.database.itemRarities, o => o.ID == item.rarity.ID), InventoryUtility.FindIndex(ItemManager.database.itemRarities, o => o.ID == intValue), filterType);
        ...
        private bool VerifyFilter(InventoryItemPropertyLookup[] properties, InventoryItemProperty property, FilterType filterType)
        {
            switch (filterType)
            {
                case FilterType.Equal:
                    return properties.Any(o => o.property.ID == property.ID);
                case FilterType.NotEqual:
                    return properties.All(o => o.property.ID != property.ID);
                case FilterType.LessThan:
                    var prop = properties.FirstOrDefault(o => o.property.ID == property.ID);
                    if (prop == null)
                ...
                case FilterType.GreatherThan:
                    var prop2 = properties.FirstOrDefault(o => o.property.ID == property.ID);
                    if (prop2 == null)
                        return false;
