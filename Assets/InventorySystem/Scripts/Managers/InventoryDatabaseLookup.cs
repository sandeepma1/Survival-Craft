...
namespace Devdog.InventorySystem
{
    public class InventoryDatabaseLookup<T> where T: UnityEngine.ScriptableObject
    {
        ...
        public void ManuallySelectDatabase()
        {
#if UNITY_EDITOR
            ...
            EditorUtility.DisplayDialog("Select an " + typeof(T).Name, "No " + typeof(T).Name + " could be found, please select one manually.", "Ok (dialog will open)");
