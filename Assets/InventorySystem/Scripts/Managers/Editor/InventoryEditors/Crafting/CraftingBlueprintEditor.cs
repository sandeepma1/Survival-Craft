...
namespace Devdog.InventorySystem.Editors
{
	public class CraftingBlueprintEditor : InventorySystemEditorCrudBase<InventoryCraftingBlueprint>
	{
		...
		public CraftingBlueprintEditor (string singleName, string pluralName, EditorWindow window, EmptyEditor parentEditor) : base (singleName, pluralName, window)
		{
		...
		protected override void DrawDetail (InventoryCraftingBlueprint selectedBlueprint, int index)
		{
			...
			if (selectedBlueprint.useItemResultNameAndDescription == false) {
				...
				selectedBlueprint.customIcon = (Sprite)EditorGUILayout.ObjectField ("Icon", selectedBlueprint.customIcon, typeof(Sprite), true);
				GUI.enabled = false;
			} else {
				GUI.enabled = false;
				...
				EditorGUILayout.TextField ("Category", cat);
				EditorGUILayout.ObjectField ("Icon", selectedBlueprint.customIcon, typeof(Sprite), true);
			}
			GUI.enabled = true;
