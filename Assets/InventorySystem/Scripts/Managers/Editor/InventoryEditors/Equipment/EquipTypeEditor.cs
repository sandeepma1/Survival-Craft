...
namespace Devdog.InventorySystem.Editors
{
    public class EquipTypeEditor : InventorySystemEditorCrudBase<InventoryEquipType>
    {
        ...
        {
            get { return new List<InventoryEquipType>(ItemManager.database.equipTypes); }
            set { ItemManager.database.equipTypes = value.ToArray(); }
        }
        ...
        public override void EditItem(InventoryEquipType item)
        {
            ...
            restrictionList.drawElementCallback += (rect, index, active, focused) =>
            {
                ...
                selectedItem.blockTypes[index] = EditorGUI.Popup(rect, selectedItem.blockTypes[index], ItemManager.database.equipTypesStrings);
