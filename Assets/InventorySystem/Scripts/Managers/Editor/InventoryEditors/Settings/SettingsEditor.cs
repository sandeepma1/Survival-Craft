...
namespace Devdog.InventorySystem.Editors
{
    public class SettingsEditor : InventorySystemEditorCrudBase<SettingsEditor.CategoryLookup>
    {
        ...
        protected InventorySettingsManager settings
        {
            ...
            {
                if(_settings == null)
                    _settings = InventorySettingsManager.instance;
        ...
        public override void Draw()
        {
            ...
            if (EditorPrefs.GetString("InventorySystem_ItemPrefabPath") == string.Empty || Directory.Exists(EditorPrefs.GetString("InventorySystem_ItemPrefabPath")) == false)
                GUI.color = Color.red;
            ...
            if (GUILayout.Button("Set path", GUILayout.Width(100)))
            {
                ...
                EditorPrefs.SetString("InventorySystem_ItemPrefabPath", "Assets" + absolutePath.Replace(Application.dataPath, ""));
            }
