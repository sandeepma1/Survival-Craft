...
{
    public class InventoryDeleteReplaceWithDialog : EditorWindow
    {
        ...
        {
            var window = EditorWindow.GetWindow<InventoryDeleteReplaceWithDialog>(true, "Replace type with", true);
        ...
        public virtual void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("This " + typeName + " is referenced " + referenceCount + " times. You can replace it with a different " + typeName + " by selecting one from the list below.", InventoryEditorStyles.labelStyle);
